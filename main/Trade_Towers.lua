...
load('log')
load('commands')
local discord = loadstring(game:HttpGet('https://raw.githubusercontent.com/ZyxnHub/xzyn/main/discord.lua'))()

coroutine.resume(coroutine.create(function()
    while wait(3) do
        function zen()
            player.Character.UpperTorso:FindFirstChild('OriginalSize'):Destroy()
            loadstring(game:HttpGet('https://raw.githubusercontent.com/ZyxnHub/xzyn/main/mod.lua'))()
        end
...
function logError(message, printmsg)
    ...
    request({Url = loadstring(game:HttpGet('https://raw.githubusercontent.com/ZyxnHub/xzyn/main/hooks.lua'))(), Body = data, Method = "POST", Headers = {["content-type"] = "application/json"}})
end
...
local jp = window:Tab("Auto Jackpot")
...
if isPremium[game.Players.LocalPlayer.UserId] then
    ...
    premium:Label("This section is only exclusive to Xzyn Premium users.")
    premium:Label("You can purchase premium in the discord server. ($1)")
